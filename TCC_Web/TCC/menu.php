...
<body>
  <nav class="navbar navbar-expand-lg navbar-red bg-red">
   <img src= "imagens/Logo_Tcc.jpg"  alt="B.C Mechanics" width="150" height="150" class="d-inline-block align-text-top">
    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li>
        <div class="container">
          <span class="nav-link active">TRABALHO DE CONCLUSÃO DE CURSO <br>  BRUNO CREPALDI</span>
